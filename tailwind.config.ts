...
const config = {
  ...
  theme: {
    colors: {
      ...
      'cyan-700': 'hsl(var(--cyan-700) / <alpha-value>)',
      'cyan-800': 'hsl(var(--cyan-800) / <alpha-value>)',
    ...
    extend: {
      ...
      colors: {
        ...
        sidebar: {
          ...
          foreground: 'hsl(var(--gray-950))',
          primary: 'hsl(var(--gray-950))',
          'primary-foreground': 'hsl(var(--background-100))',
          accent: 'hsl(var(--gray-100))',
          'accent-foreground': 'hsl(var(--gray-950))',
          border: 'hsl(var(--gray-400))',
          ring: 'hsl(var(--gray-950))',
        },
      },
